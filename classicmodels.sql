...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 04, 2023 at 03:09 PM
...
(1056, 'Hill', 'Mary', 'x4611', 'mary.hill@classicmodelcars.com', '1', 1002, 'VP Sales'),
(1076, 'Firrelli', 'Jeff', 'x9273', 'jfirrelli@classicmodelcars.com', '1', 1002, 'VP Marketing'),
(1088, 'Patterson', 'William', 'x4871', 'wpatterson@classicmodelcars.com', '6', 1056, 'Sales Manager (APAC)'),
(1102, 'Bondur', 'Gerard', 'x5408', 'gbondur@classicmodelcars.com', '4', 1056, 'Sale Manager (EMEA)'),
(1143, 'Bow', 'Anthony', 'x5428', 'abow@classicmodelcars.com', '1', 1056, 'Sales Manager (NA)'),
(1165, 'Jennings', 'Leslie', 'x3291', 'ljennings@classicmodelcars.com', '11', 1143, 'Sales Rep'),
(1166, 'Thompson', 'Leslie', 'x4065', 'lthompson@classicmodelcars.com', '11', 1143, 'Sales Rep'),
(1188, 'Firrelli', 'Julie', 'x2173', 'jfirrelli@classicmodelcars.com', '11', 1143, 'Sales Rep'),
(1216, 'Patterson', 'Steve', 'x4334', 'spatterson@classicmodelcars.com', '11', 1143, 'Sales Rep'),
(1286, 'Tseng', 'Foon Yue', 'x2248', 'ftseng@classicmodelcars.com', '11', 1143, 'Sales Rep'),
(1323, 'Vanauf', 'George', 'x4102', 'gvanauf@classicmodelcars.com', '11', 1143, 'Sales Rep'),
(1337, 'Bondur', 'Loui', 'x6493', 'lbondur@classicmodelcars.com', '11', 1102, 'Sales Rep'),
(1370, 'Hernandez', 'Gerard', 'x2028', 'ghernande@classicmodelcars.com', '11', 1102, 'Sales Rep'),
(1401, 'Castillo', 'Pamela', 'x2759', 'pcastillo@classicmodelcars.com', '11', 1102, 'Sales Rep'),
(1501, 'Bott', 'Larry', 'x2311', 'lbott@classicmodelcars.com', '11', 1102, 'Sales Rep'),
(1504, 'Jones', 'Barry', 'x102', 'bjones@classicmodelcars.com', '11', 1102, 'Sales Rep'),
(1611, 'Fixter', 'Andy', 'x101', 'afixter@w3programmers.com', '11', 1088, 'Sales Rep'),
(1612, 'Marsh', 'Peter', 'x102', 'pmarsh@w3programmers.com', '11', 1088, 'Sales Rep'),
(1619, 'King', 'Tom', 'x103', 'tking@w3programmers.com', '11', 1088, 'Sales Rep'),
(1621, 'Nishi', 'Mami', 'x101', 'mnishi@classicmodelcars.com', '11', 1056, 'Sales Rep'),
(1625, 'Kato', 'Yoshimi', 'x102', 'ykato@classicmodelcars.com', '11', 1621, 'Sales Rep'),
(1702, 'Gerard', 'Martin', 'x2312', 'mgerard@classicmodelcars.com', '11', 1102, 'Sales Rep');
...
CREATE TABLE `patients` (
  ...
  `minimum_allowed_weight` decimal(5,2) NOT NULL,
  `maximum_allowed_weight` decimal(5,2) NOT NULL
...
INSERT INTO `patients` (`id`, `name`, `weight`, `minimum_allowed_weight`, `maximum_allowed_weight`) VALUES
(2, 'Jane Doe', 55.20, 50.00, 70.00),
(3, 'Bob Smith', 65.00, 75.00, 90.00),
(4, 'Alice Johnson', 65.80, 60.00, 70.00),
(6, 'Eva Miller', 45.00, 50.00, 60.00),
(7, 'David Johnson', 95.50, 90.00, 100.00),
(8, 'Sophia Williams', 62.30, 55.00, 65.00),
(9, 'William Davis', 85.80, 70.00, 80.00),
(10, 'Olivia Smith', 55.50, 50.00, 60.00);
...
CREATE TABLE `sales` (
  ...
  `orderValue` decimal(42,2) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
...
INSERT INTO `sales` (`productLine`, `orderYear`, `orderValue`) VALUES
...
CREATE TABLE `stats` (
  ...
  `totalCustomer` int(11) DEFAULT NULL,
...
INSERT INTO `stats` (`totalProduct`, `totalCustomer`, `totalOrder`) VALUES
(110, 122, 326);
...
INSERT INTO `suppliers` (`supplierNumber`, `supplierName`, `phone`, `addressLine1`, `addressLine2`, `city`, `state`, `postalCode`, `country`, `customerNumber`) VALUES
...
(1, 'Imran Khan', 22, 'Rajshahi,Bangladesh'),
(2, 'Hasibul Islam', 25, 'Noakhalid,Bangladesh'),
(3, 'Toriqul Islam', 29, 'Dhaka,Bangladesh'),
(4, 'Mostafizur Rahman', 24, 'Khulna,Bangladesh'),
(5, 'Noman Ali Khan', 25, 'Dhaka,Bangladesh');
...
--
ALTER TABLE `suppliers`
  MODIFY `supplierNumber` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
